...
var scrollCount=0;
var sourcePic = ["http://datanews.caixin.com/mobile/flood/js/bg.jpg","http://datanews.caixin.com/mobile/flood/js/map-bg.png","http://datanews.caixin.com/mobile/flood/js/cover-m.png"];
...
function initMainPage()
{
	...
	if($(window).width()>=768){
		$('#sroll-tip-image').attr('src','http://datanews.caixin.com/mobile/flood/js/images/scroll-tip-pc.png');
		...
		$(".damage-chart").find("img").attr("src","http://datanews.caixin.com/mobile/flood/js/images/damage-m.png");

		for(var i=0;i<6;i++)
		$(".dilishu ul").eq(1).find("li").eq(i).find("img").attr("src","images/mobile/book-"+(i+1)+".jpg");

		$(".chart98").find("img").attr("src","http://datanews.caixin.com/mobile/flood/js/images/mobile/chart-3-1.png");
		for(var i=0;i<4;i++)
		...
		$(".cover-title").attr("src","http://datanews.caixin.com/mobile/flood/js/images/cover-m.png").attr("width","100%")
