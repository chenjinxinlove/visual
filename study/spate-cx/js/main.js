...
if($(window).width()>=768){
    ...
    $(".damage-chart").find("img").attr("src","images/damage-m.png");

    for(var i=0;i<6;i++)
        $(".dilishu ul").eq(1).find("li").eq(i).find("img").attr("src","images/mobile/book-"+(i+1)+".jpg");

    $(".chart98").find("img").attr("src","images/mobile/chart-3-1.png");
    for(var i=0;i<4;i++)
    ...
    $(".cover-title").attr("src","images/cover-m.png").attr("width","100%")
