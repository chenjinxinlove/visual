...
var scrollCount=0;
var sourcePic = ["index-1.htm"/*tpa=http://datanews.caixin.com/mobile/flood/js/bg.jpg*/,"index-1.htm"/*tpa=http://datanews.caixin.com/mobile/flood/js/part-0-bg-m.jpg*/];
...
function initMainPage()
{
	...
	if($(window).width()>=768){
		$('#sroll-tip-image').attr('src','index-1.htm'/*tpa=http://datanews.caixin.com/mobile/flood/js/images/scroll-tip-pc.png*/);
		...
		$(".damage-chart").find("img").attr("src","index-1.htm"/*tpa=http://datanews.caixin.com/mobile/flood/js/images/damage-m.png*/);

		for(var i=0;i<6;i++)
		$(".dilishu ul").eq(1).find("li").eq(i).find("img").attr("src","images/mobile/book-"+(i+1)+".jpg");

		$(".chart98").find("img").attr("src","index-1.htm"/*tpa=http://datanews.caixin.com/mobile/flood/js/images/mobile/chart-3-1.png*/);
		for(var i=0;i<4;i++)
		...
		$(".cover-title").attr("src","index-1.htm"/*tpa=http://datanews.caixin.com/mobile/flood/js/images/cover-m.png*/).attr("width","100%")
