...
function mapPlay(){
    ...
    d3.json("http://datanews.caixin.com/mobile/flood/data/rain.json", function(error, root) {
...
//日期坐标
    ...
    function drawCityButton(){
        ...
        d3.json("http://datanews.caixin.com/mobile/flood/data/cities.json", function(error, root) {
            if (error)
                return console.error(error);
    ...
    function clickCityButton(city){
        ...
        d3.json("http://datanews.caixin.com/mobile/flood/data/rain_full.json", function(error, root) {
