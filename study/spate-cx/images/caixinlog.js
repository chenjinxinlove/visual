...
sEn[24]="http://file.caixin.com/webjs/common/search.live.com";	keyWord[24]="q";
sEn[25]="soso";			keyWord[25]="w";
sEn[26]="http://file.caixin.com/webjs/common/google.com";		keyWord[26]="q";
...
function GetResident() {
	...
	if(cx_from=='' || cx_from==undefined || cx_from==null){
		...
		if (ref.indexOf("http://file.caixin.com/webjs/common/360.cn") > -1) {
			cx_from = "http://file.caixin.com/webjs/common/360.cn";
    	}else if (ref.indexOf("http://file.caixin.com/webjs/common/sh.qihoo.com") > -1) {
			cx_from = "http://file.caixin.com/webjs/common/sh.qihoo.com";
    	}
	}
...
function GetResidentTime() 
{
	...
	time_bam = 0;
    var UserPay = getCookie("SA_USER_AUTH_Statistics");
    var ext_num1 = 0;
    if(typeof(UserPay) != "undefined" && UserPay != null && parseInt(UserPay) == 1){
        ext_num1 = 1;
    }
    //ext_num2:文章收费状态
    var ext_num2 = -1;
    ...
    //new log start
	var newLogPage = "count.gif"/*tpa=http://apollo.caixin.com/count.gif*/;
	var newLogUrl = encodeURI(newLogPage + "?" + New_Para_+"&st="+time_bam+"&daye="+pageClose.getTime()+Math.round(Math.random()*2147483647))+"&pageurl="+_ourplusPageurl + "&extNum1=" + ext_num1 + "&extNum2=" + ext_num2;
...
function setCookie(name, value, expires)
{
	...
	var domain = (argc > 4) ? argv[4] : 'http://file.caixin.com/webjs/common/caixin.com';
	...
	if(expires!=null) 
	{
	    ...
	    document.cookie = name + "=" + escape (value) +((expires == "setnull") ? "" : ("; expires="+ expdate.toGMTString()))
		    + ((path == null) ? "" : ("; path=" + path)) +((domain == null) ? "" : ("http://file.caixin.com/webjs/common/; domain=caixin.com"))
		    + ((secure == true) ? "; secure=" : "");
   }
}
